...
urlpatterns = [
    ...
    path('<str:project_name>/reschedule', views.reschedule_task, name="reschedule_task"),
    ...
    path('<str:project_name>/reschedule_subtask', views.reschedule_subtask, name="reschedule_subtask"),
